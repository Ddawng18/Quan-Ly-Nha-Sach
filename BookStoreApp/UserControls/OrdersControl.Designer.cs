...
partial class OrdersControl
{
    ...
    private void InitializeComponent()
    {
        ...
        panelDetailToolbar = new Panel();
        lblSetStatus = new Label();
        ...
        panelDetailToolbar.SuspendLayout();
        ...
        panelDetailToolbar.Controls.Add(btnUpdateStatus);
        panelDetailToolbar.Controls.Add(cboNewStatus);
        panelDetailToolbar.Controls.Add(lblSetStatus);
        panelDetailToolbar.Dock = DockStyle.Top;
        panelDetailToolbar.Height = 44;
        panelDetailToolbar.Name = "panelDetailToolbar";
        lblSetStatus.AutoSize = true;
        lblSetStatus.Location = new Point(0, 12);
        lblSetStatus.Text = "Set Status";
        ...
        splitContainer.Panel2.Controls.Add(panelDetailToolbar);
        ...
        panelDetailToolbar.ResumeLayout(false);
        panelDetailToolbar.PerformLayout();
    ...
    private Panel panelDetailToolbar;
    private Label lblSetStatus;
